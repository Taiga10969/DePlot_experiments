...
class  DePlotDataset(Dataset):
    def __init__(self, csv_path, max_source_length, max_target_length, task_prefix=None, change_id=False, tokenizer=None):
    ...
    def __getitem__(self, index):
        ...
        if self.task_prefix is not None:
            deplot_text = self.task_prefix + deplot_text
